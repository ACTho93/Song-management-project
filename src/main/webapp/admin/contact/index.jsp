                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="table-responsive">
                            <div class="row">
                                <div class="col-sm-6">
                                    <a href="<%=request.getContextPath() %>/admin/contact/add" class="btn btn-success btn-md">Thêm</a><br/>
									<%
										String msg = "";
										String error = "";
						                ...
						                case "2": 
											%>
											<br/><span style="color: green;background: yellow; font-weight: bold; padding: 5px" >Thêm liên hệ thành công!</span><br/>
											<%
											break;	
						                case "3": 
											%>
											<br/><span style="color: green;background: yellow; font-weight: bold; padding: 5px" >Sửa liên hệ thành công!</span><br/>
											<%
											break;	
										}
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                               ...
                               %>
                                    <tr>
                                        ...
                                        <td class="center">
                                        	<a href="<%=request.getContextPath() %>/admin/contact/edit?cid=<%=objC.getId() %>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
