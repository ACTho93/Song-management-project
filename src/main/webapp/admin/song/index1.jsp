                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <%
                                	...
                                	ArrayList<Song> listSongByUser =(ArrayList<Song>) request.getAttribute("listSongByUser");
                                	if(listSongByUser != null && listSongByUser.size() > 0 ){
                                		for(Song item: listSongByUser){
                                %>
                                    <tr>
                                        <td><%=item.getId() %></td>
