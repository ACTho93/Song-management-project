                        ...
                        <div class="table-responsive">
                            <div class="row">
                                ...
                                <div class="col-sm-6" style="text-align: right;">
                                    <form method="get" action="<%=request.getContextPath()%>/admin/song/seach">
                                ...
                                %>
                                    <tr>
                                        ...
                                        <%if(item.getPicture().isEmpty()){ %>
                                        	chưa có hình ảnh 
                                        <%}else { %>
                                        <img width="100px" height="100px" src="<%=request.getContextPath() %>/files/<%=item.getPicture() %>" alt="<%=item.getName()%>"/>
                                         <%} %>
                                        </td>
