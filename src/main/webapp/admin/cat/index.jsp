                        ...
                        <div class="table-responsive">
                            <div class="row">
                                ...
                                <div class="col-sm-6" style="text-align: right;">
                                    <form method="get" action="<%=request.getContextPath()%>/admin/cat/seach">
                                        <input type="submit"  value="Tìm kiếm" class="btn btn-warning btn-sm" style="float:right" />
                                        <input  type="search" class="form-control input-sm"  name="seach" placeholder="Nhập tên danh mục" style="float:right; width: 300px;" /></a>
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td class="center">
                                            ...
                                            <a onclick="return confirm('Bạn đồng ý xóa danh mục!')"  href="<%=request.getContextPath() %>/admin/cat/del?cid=<%=item.getId() %>" title="" class="btn btn-danger"  ><i class="fa fa-pencil"></i> Xóa</a>
                                        </td>
                                    </tr>
								<% }} else { %>
                                ...
                                <div class="col-sm-6" style="text-align: right;">
                                    <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                                        <ul class="pagination">
											...
											%>
                                            <li class="paginate_button previous " aria-controls="dataTables-example" tabindex="0" id="dataTables-example_previous"><a href="<%=request.getContextPath()%>/admin/cats?page=<%=currentPage%>">Trang trước</a></li>
                                            <% } else {  %>
