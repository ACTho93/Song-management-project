...
<div class="content_resize">
  <div class="mainbar">
   ...
   %>
    <p class="pages"><small>Hiển thị <%=currentPage %> của <%=numberOfPages %> trang</small>
    <%
	...
	%>
    <a href="<%=request.getContextPath()%>/<%=StringUtil.makeSlug(category.getName()) %>-<%=category.getId()%>/page/<%=currentPage+1 %>">&raquo;</a></p>
    <% } %>
